 ...
 * Unified Teams API
 *
 * GET /api/v1/teams - Get all teams (requires maintainer+ role)
 * GET /api/v1/teams?users=true - Get all users with their team assignments (requires maintainer+ role)
 * POST /api/v1/teams - Create a new team OR assign a user to a team (requires maintainer+ role)
 *   - Team creation: { name: string, description?: string }
 *   - User assignment: { userId: string, teamId: string }
 * DELETE /api/v1/teams - Remove a user from a team (requires maintainer+ role)
 */
...
/**
 * Handle GET /api/v1/teams - Get all teams
 */
...
/**
 * Handle GET /api/v1/teams?users=true - Get all users with their team assignments
 */
...
/**
 * Handle POST /api/v1/teams - Create a new team
 */
...
/**
 * Handle POST /api/v1/teams - Assign a user to a team
 */
...
/**
 * Handle DELETE /api/v1/teams - Remove a user from a team
 */
