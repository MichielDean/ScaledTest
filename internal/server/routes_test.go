...
func TestAuthenticatedEndpointsWithToken(t *testing.T) {
	...
	endpoints := []struct {
		...
		{"GET", "/api/v1/analytics/trends", http.StatusServiceUnavailable},
		{"GET", "/api/v1/analytics/flaky-tests", http.StatusServiceUnavailable},
		{"GET", "/api/v1/analytics/error-analysis", http.StatusServiceUnavailable},
		{"GET", "/api/v1/analytics/duration-distribution", http.StatusServiceUnavailable},
